...
describeRunIf(process.env.TEST_ENV !== 'node', 'shallowMount', () => {
  ...
  it('stubs dynamic components', () => {
    ...
    expect(wrapper.html()).to.contain('<childcomponent-stub text="normal">')
    expect(wrapper.html()).to.contain('<childcomponent-stub text="data">')
    expect(wrapper.html()).to.contain('<childcomponent-stub text="computed">')
    expect(wrapper.html()).to.contain('<childcomponent-stub text="method">')
  })
})
